    ...
    <body>
        <div class="container">
            <div class="row card card-signin mb-5 ml-2 mr-2 mt-5" >
                <div class='mt-5 text-center col-10'><h2>Thank you for using our platform!</h2></div>
                <div class="mt-2 text-center col-10" style="color:#AAABBC"><h4>Your friend will see the infomation you submited the next time they log in.</h4></div>
                <div class="mt-2 text-center col-10" style="color:#AAABBC"><h4>You'll be shortly redirected to the home page.</h4></div>
